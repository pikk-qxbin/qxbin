...
int main() {
    ...
    printf("\nDone. QxBin C version ready for edge deployment, embedded systems, or learning.\n");
    printf("Compile: gcc -o qxbin_edge qxbin_edge.c -lm\n");
    printf("Next: Add CSV export for external visualization or multi-cubit chains.\n");
